package mock.brains.basecomponents.core.model;
...
public class User {
    ...
    public static final String CREATE_TABLE = ""
            + Db.CREATE_TABLE + TABLE + Db.OPEN_BRACKET
            + Db.COL_ID + Db.INT_NOT_NULL_PK_AUTOINCREMENT + Db.COMMA
            + COL_USER_ID + Db.INTEGER_NOT_NULL + Db.COMMA
            + COL_NAME + Db.TEXT_NOT_NULL + Db.COMMA
            + COL_USER_NAME + Db.TEXT_NOT_NULL + Db.COMMA
            + COL_EMAIL + Db.TEXT_NOT_NULL + Db.COMMA
            + COL_PHONE + Db.TEXT_NOT_NULL + Db.COMMA
            + COL_WEB_SITE + Db.TEXT_NOT_NULL
            + Db.CLOSE_BRACKET;
